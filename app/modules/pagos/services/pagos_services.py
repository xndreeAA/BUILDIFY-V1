from flask import current_app, abort, json, redirect
...
class PagosServices:
    ...
    @staticmethod
    def create_checkout_session(id_usuario):
        ...
        if not carrito:
            return {"error": "El carrito no existe."}, 400
